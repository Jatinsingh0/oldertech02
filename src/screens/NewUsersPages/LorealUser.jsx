...
export default function LorealUser() {
  ...
  const namePlaceholder = <Text name="name" />;

  return (
    <>
      <div style={{ display: type !== "loreal" ? "none" : "block" }}>
            ...
            <div className="profile-details" style={{ background: "#F2F2F5" }}>
              <div className="profile-container">
                ...
                <div className="profile-contents">
                  ...
                  <div className="loreal-new-user-logo">
                    <img src="/lorealbooklet/loreal-logo.png" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="pannel" style={{ paddingTop: 234 }}>
          ...
          <div className="clic-header-title-section">
            <Text name="Becoming_leaders" />
          </div>

          <ImageSlider images={images} />

          <div className="clic-header-title-section" style={{ fontSize: 12 }}>
            <Text name="start_recycling" />
          </div>

          <form className="new-clic-user-form" onSubmit={handleSubmit}>
            <input
              placeholder="Nombre"
              type="text"
              name="name"
            ...
            <input
              placeholder="NIF/Intercommunitarian #"
              type="text"
              name="nif"
              value={formData.nif}
              onChange={handleChange}
            ...
            <input
              placeholder="Cantidad de salones"
              type="number"
              name="salons"
            ...
            <button type="submit">Confirm with Acrobat Signature</button>
          </form>
        </div>
      </div>
    </>
